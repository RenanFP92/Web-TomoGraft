            ...
            <a className="navbar-brand" href="#" style={{ color: 'White ' , fontSize: '30px'  }}>TomoGraft</a>
                ...
                <div className="collapse navbar-collapse justify-content-center" id="navbarNav">
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="#servicios" style={{ color: 'White ' , fontSize: '19px'  }}>Servicios y Tecnología</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#testimonios" style={{ color: 'White ' , fontSize: '19px'  }}>Testimonios</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="#faq" style={{ color: 'White ' , fontSize: '19px'  }}>Preguntas Frecuentes</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="" style={{ color: 'White ' , fontSize: '19px'  }}>Ubícanos</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="" style={{ color: 'White ' , fontSize: '19px'  }}>Contáctanos</a>
                        </li>
                    </ul>
                </div>
        </div>
